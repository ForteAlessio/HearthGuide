...
//LIBRERIA PER LA VIEW DI LOADING 
    ...
    */
    ...
    fileprivate func update() {
        ...
        if (self.titleLabel == nil) {
            ...
            self.titleLabel?.frame = CGRect(x: loaderTitleMargin, y: loaderSpinnerMarginTop + loadingViewSize, width: self.frame.width - loaderTitleMargin*2, height: 55.0)//42.0)
        }
